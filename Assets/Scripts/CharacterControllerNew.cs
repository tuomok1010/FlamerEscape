...
// NOTE: the only difference between this and MyCharacterController is that this has rotation disabled. (this is to prevent the player sprite
// from rotating. This script is used in the new Player prefab to test animation stuff)
...
namespace ECM.Walkthrough.CustomCharacterController
{
    ...
    public class CharacterControllerNew : BaseCharacterController
    {
